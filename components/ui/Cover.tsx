...
// Define types for the Cover component props
interface CoverProps {
    children: React.ReactNode;
    className?: string;
}

// Convert Cover component to TypeScript
...
// Define types for the Beam component props
interface BeamProps {
    className?: string;
    delay?: number;
    duration?: number;
...
// Convert Beam component to TypeScript
...
// Define types for the CircleIcon component props
interface CircleIconProps {
    className?: string;
    delay?: number;
}

// Convert CircleIcon component to TypeScript
